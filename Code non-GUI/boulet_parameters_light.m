...
% List of parameters for boulet_stimulation_light and
% boulet_model_main_light
    % INPUTS: none
...
% Light version modifications:
    ...
    % noise variable is defined only for subset of iterations
    % (see noise_filt variable and boulet_model_light3)
...
if noise_mem == 1
    ...
    % apply filter during iterations
    niter_filt = 1000;
